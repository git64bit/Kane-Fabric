...
def main() -> int:
    ...
    checks = {
        ...
        "termination_framework": "Statewide sale and removal framework" in decoded_html,
        "termination_objector_collection": "Add objecting owner" in decoded_html,
        "termination_lienholder_collection": "Add lienholder record" in decoded_html,
        "termination_sale_boundary": "majority of unit owners for a 2-unit property" in decoded_html and "at least 66 2/3% for a 3-unit property" in decoded_html and "at least 75% for a property containing 4 or more units" in decoded_html and "within 20 days after the meeting" in decoded_html,
        "termination_removal_boundary": "all unit owners" in decoded_html and "all lienholders affecting units" in decoded_html and "owned in common" in decoded_html and "former percentage interest in the common elements" in decoded_html,
        "complaints_framework": "Statewide complaint and Ombudsperson framework" in decoded_html,
        "complaints_case_collection": "Add complaint" in decoded_html,
        "complaints_ombudsperson_collection": "Add assistance request" in decoded_html,
        "complaints_policy_boundary": "within 180 days after receipt" in decoded_html and "marked clearly and conspicuously as \"final\"" in decoded_html and "January 1, 2029" in decoded_html,
        "complaints_assistance_boundary": "preceding 2 calendar years" in decoded_html and "within 30 days after receipt" in decoded_html and "no earlier than 90 days" in decoded_html and "community association managers" in decoded_html,
