-- Kane Fabric durable geographic building identity and official-footprint mappings.
-- Table names remain project_building/project_building_source_mapping during MS-2
-- for behavior-preserving compatibility with the Kane Condo 0.4 donor schema.
...
INSERT INTO gpkg_contents (
    ...
    (
        'project_building', 'attributes', 'Kane Fabric geographic buildings',
        'Durable geographic building identities independent of official source identifiers',
        NULL, NULL, NULL, NULL, NULL
    ),
    (
        'project_building_source_mapping', 'attributes', 'Kane Fabric building mappings',
        'Auditable mappings between durable geographic identities and official footprints',
        NULL, NULL, NULL, NULL, NULL
    );
