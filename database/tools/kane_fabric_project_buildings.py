#!/usr/bin/env python3
"""Create, validate, and inspect Kane Fabric durable geographic building identities."""
...
def accepted_release_context(
    ...
    if row["lifecycle_status"] != "accepted":
        raise RuntimeError("Project identity seed requires an accepted building release")
