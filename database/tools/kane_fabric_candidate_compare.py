#!/usr/bin/env python3
"""Deterministically compare validated Kane Fabric source candidates with accepted releases."""
...
import kane_fabric_building_candidate as kane_building_candidate
